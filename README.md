## **e-ToolStore**
### Online shop of industrial tools

This project is my result of consolidating in practice the study of some popular Java EE frameworks:

*Back-end:*
- Spring Core, Spring Web-MVC, Spring Security (integrated with Thymeleaf Security and Spring DATA JPA), Maven, Apache commons (photo upload), Javax Mail, Log4j (integrated with GSON).
